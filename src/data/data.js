...
export const siteData = {
  studyAbroad: [
      ...
      courses: [
        {
          ...
          details: ["MIT", "Stanford University", "Carnegie Mellon University"],
        },
        {
          courseName: "Medicine",
    ...
    },
    {
      ...
      courses: [
        {
          courseName: "IT & Software Engineering",
          details: [
  ...
  testimonials: [
    ...
    },
    {
      ...
      text: "I couldn't have achieved this without the continuous guidance on the right courses and universities. Simply the best consultants!",
      image:
